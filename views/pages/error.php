...
<!DOCTYPE html>
    ...
    <body>
        ...
        <div class="back-to-home rounded d-none d-sm-block">
            <a href="/index.php?controller=login&action=dangnhap" class="btn btn-icon btn-primary"><i data-feather="home" class="icons"></i></a>
        </div>

        <!-- Hero Start -->
        <section class="bg-home d-flex bg-light align-items-center" style="background: url('../assets/images/bg-lines-one.png') center;">
            <div class="container">
